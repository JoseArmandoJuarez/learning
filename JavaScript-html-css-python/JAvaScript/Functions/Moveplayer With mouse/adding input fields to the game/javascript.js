  ...
  function getMousePos(canvas, evt) {
    ...
    function mainLoop(){
      ...
      drawBallNumbers(balls);
        ...
        //animated the ball that is bouncing all over the walls
        moveAllBalls(balls);
    ...
    {
        var colors = ['red', 'blue', 'cyan', 'yellow', 'purple', 'pink', 'green', 'orange'];
        //a value between 0 and color.length-1
        //Math.round = rounded value
        //Math.random() a value between 0 and 1
        var colorIndex = Math.round((color.length-1)*Math.random());
    ...
    function drawBallNumbers(balls){
        ...
        if(goodBallEaten === numberOfGooedBalls){
            ctx.fillText("You Win! Fianl score : " + (initialNumberOfBalls - wrongBallsEaten), 20, 30);
        } 
        else {
