  ...
  for (var i = 0; i < spans.length; i++) {
    if (spans[i].innerHTML === typed) {
      ...
      if (spans[i].classList.contains("bg")) {
        ...
        // if it dont have class, if it is not first letter or if the letter before it dont have https://codepen.io/nikola1970/pen/oxXbmb#settings-behaviorclass (this is done to avoid marking the letters who are not in order for being checked, for example if you have two "A"s so to avoid marking both of them if the first one is at the index 0 and second at index 5 for example)
