...
console.log("c1.length = " + c1.length); //displays c1.length = 10
...
let a2 = [1, 2];
console.log("a2.length = " + a2.length); //displays a2.length = 2

// remember that arrays are objects, and that we can add properties to objects
// after their creation
a2.name = "Michel"; // AVOID!!!

console.log("a2.length after we set name='Michel', still:" + a2.length); //displays 2
...
a2.length = 5;
console.log("a2 after a2.length = 5: " + a2); //displays 1,2,,,
...
a2.length = 1;
console.log("a2 after a2.length = 1: " + a2); //displays 1
// type a1 in the devtool console!
...
sort: sort the elements in the array. Either alphabetically if they are strings, or in ascending 
order if they are numbers. There is also a way to sort the elements using other criteria, which 
is explained a bit further on in the course. With a call to var b = a.sort(), a is also sorted. 
The sort method sorts the array + returns it.
