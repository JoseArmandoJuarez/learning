...
If its value is a primitive value (number, string, or boolean), 
the variable contains this value directly.

If its value is an object, the variable contains the memory address 
of the object. We say that this variable "points to" an object 
(or references this object). Accessing the variable will automatically 
resolve the reference, meaning that the value of the variable is the 
referenced object.
*/
